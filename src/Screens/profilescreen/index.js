          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: width * 0.04 }}>
            <View style={styles.prof}>
              <View style={styles.profileimage}>
                <Image resizeMode='cover' style={{ width: "100%", height: "100%" }} source={profileimage} />
              </View>
      ...
      <ScrollView>
        <View style={{ paddingHorizontal: width * 0.03, }}>
          ...
          <View style={styles.skillscontainer}>
            ...
            <TouchableOpacity>
              <Feather name="edit" color="#8D8D8D" size={calculateFontSize(20)} onPress={() => navigation.navigate('addskill')} />
            </TouchableOpacity>
          </View>
          ...
          <View style={{ paddingHorizontal: width * 0.02 }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
              ...
              >
                <Feather name="edit" color="#8D8D8D" size={calculateFontSize(20)} />
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.badgeimagecontainer}>
              <View style={styles.badgeimagecontainerpareent}>
                <View style={styles.idimage}>
                  <Image resizeMode='contain' style={{ width: "100%", height: "100%" }} source={idimage} />
                </View>
              </View>
            </View>
            ...
            <View style={styles.btcontainer}>
              <View style={styles.btn}>
                <View style={styles.iconbtn}>
                  ...
                  <Text style={{ color: "#fff", fontSize: calculateFontSize(14), marginHorizontal: width * 0.05 }}>Employment</Text>
                </View>
                <Text style={{ color: "#fff", fontSize: calculateFontSize(12) }}>Part-time</Text>
              </View>
              ...
              <View style={{ marginVertical: height * 0.01 }}>
                <View style={styles.btn}>
                  <View style={styles.iconbtn}>
                    ...
                    <Text style={{ color: "#fff", fontSize: calculateFontSize(14), marginHorizontal: width * 0.05 }}>Availability</Text>
                  </View>
                  <Text style={{ color: "#fff", fontSize: calculateFontSize(12) }}>Immediate Start</Text>
                </View>
              </View>
              ...
              <View style={{ marginVertical: height * 0.001 }}>
                <View style={styles.btn}>
                  <View style={styles.iconbtn}>
                    ...
                    <Text style={{ color: "#fff", fontSize: calculateFontSize(14), marginHorizontal: width * 0.05 }}>Willing to travel</Text>
                  </View>
                  <Text style={{ color: "#fff", fontSize: calculateFontSize(12) }}>50 Km</Text>
                </View>
              </View>
