...
const SavedJobScreen = ({savedJobs}) => {
  const renderJobs = () => {
          ...
          <View style={styles.sugestboxjob} key={index}>
            <View
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View style={{marginLeft: width * 0.04}}>
                  <Text style={styles.sugestjobtext}>{job.title}</Text>
                  <Text style={styles.sugestsubtext}>{job.company}</Text>
                </View>
              </View>
            ...
            <View style={styles.btcontainer}>
              <View style={styles.jobtiming}>
                <Text style={styles.textjobtiming}>{job.jobTime}</Text>
              </View>
              <View style={styles.jobtiming}>
                <Text style={styles.textjobtiming}>{job.armed}</Text>
              </View>
              <View style={styles.jobtiming}>
                <Text style={styles.textjobtiming}>{job.location}</Text>
              </View>
            </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ArrowBack />
      <Text style={styles.txt}>saved jobs</Text>
