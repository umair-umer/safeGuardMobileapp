...
const IndividualSuceesfullyCompanyRegister = ({ navigation }) => {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ paddingHorizontal: width * 0.03, }}>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", marginTop: height * 0.04, }}>
                                ...
                                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: width * 0.02 }}>
                                    <View style={styles.prof}>
                                        <View style={styles.profileimage}>
                                            <Image resizeMode='cover' style={{ width: "1005", height: "100%" }} source={{ uri: profileImage }} />
                                        </View>
                                    ...
                                    <TouchableOpacity>
                                        <Feather name="edit" color="#fff" size={calculateFontSize(10)} onPress={() => navigation.navigate('editprofile')} />
                                    </TouchableOpacity>
                                </View>
                    ...
                    <Button name={"Done"} fill={true} onPress={() => { navigation.navigate('Individualbottomtab') }} />
                </View>
            </View>
        </SafeAreaView>
    )
...
export default IndividualSuceesfullyCompanyRegister
